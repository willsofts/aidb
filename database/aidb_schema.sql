  ...
  ) COMMENT='table keep customer information';
  ...
  ) COMMENT='table keep order master';
  ...
  ) COMMENT='table keep product under order from table torder';
  ...
  ) COMMENT='table keep product information';
