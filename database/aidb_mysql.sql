...
CREATE TABLE IF NOT EXISTS `cust_order` (
  ...
  `order_amount` decimal(20,6) NOT NULL COMMENT 'order amount',
  PRIMARY KEY (`order_id`,`customer_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='table keep order master';

INSERT INTO `cust_order` (`order_id`, `customer_id`, `order_date`, `order_time`, `order_unit`, `order_amount`) VALUES
	('ORD-00001', 'CUST-10001', '2024-03-01', '08:43:45', 2, 258.000000),
	('ORD-00002', 'CUST-10002', '2024-03-02', '08:47:45', 3, 417.000000),
	('ORD-00003', 'CUST-10003', '2024-03-03', '08:50:58', 5, 795.000000),
	('ORD-00004', 'CUST-10004', '2024-03-04', '08:53:00', 4, 476.000000),
	('ORD-00005', 'CUST-10005', '2024-03-05', '08:55:16', 2, 368.000000),
	('ORD-00006', 'CUST-10006', '2024-03-06', '08:58:02', 3, 447.000000),
	('ORD-00007', 'CUST-10007', '2024-03-06', '09:00:41', 6, 804.000000),
	('ORD-00008', 'CUST-10008', '2024-03-07', '09:07:03', 1, 199.000000),
	('ORD-00009', 'CUST-10009', '2024-03-07', '09:09:05', 2, 338.000000),
	('ORD-00010', 'CUST-10010', '2024-03-07', '09:10:41', 2, 238.000000),
	('ORD-00011', 'CUST-10011', '2024-03-07', '09:12:46', 1, 189.000000),
	('ORD-00012', 'CUST-10012', '2024-03-07', '09:14:58', 2, 318.000000);
...
CREATE TABLE IF NOT EXISTS `cust_order_detail` (
  ...
  `order_price` decimal(20,6) NOT NULL COMMENT 'order price',
  `order_amount` decimal(20,6) NOT NULL COMMENT 'order amount',
  PRIMARY KEY (`order_id`,`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='table keep product under order from table torder';

INSERT INTO `cust_order_detail` (`order_id`, `product_id`, `order_date`, `order_time`, `order_unit`, `order_price`, `order_amount`) VALUES
	('ORD-00001', 'PR001', '2024-03-01', '08:43:45', 2, 129.000000, 258.000000),
	('ORD-00002', 'PR001', '2024-03-02', '08:47:45', 2, 129.000000, 258.000000),
	('ORD-00002', 'PR006', '2024-03-02', '08:47:45', 1, 159.000000, 159.000000),
	('ORD-00003', 'PR002', '2024-03-03', '08:50:58', 5, 159.000000, 795.000000),
	('ORD-00004', 'PR005', '2024-03-04', '08:53:00', 4, 119.000000, 476.000000),
	('ORD-00005', 'PR008', '2024-03-05', '08:55:16', 1, 179.000000, 179.000000),
	('ORD-00005', 'PR009', '2024-03-05', '08:55:16', 1, 189.000000, 189.000000),
	('ORD-00006', 'PR004', '2024-03-06', '08:58:02', 3, 149.000000, 447.000000),
	('ORD-00007', 'PR001', '2024-03-06', '09:00:41', 3, 129.000000, 387.000000),
	('ORD-00007', 'PR003', '2024-03-06', '09:00:41', 3, 139.000000, 417.000000),
	('ORD-00008', 'PR010', '2024-03-07', '09:07:03', 1, 199.000000, 199.000000),
	('ORD-00009', 'PR007', '2024-03-07', '09:09:05', 2, 169.000000, 338.000000),
	('ORD-00010', 'PR005', '2024-03-07', '09:10:41', 2, 119.000000, 238.000000),
	('ORD-00011', 'PR009', '2024-03-07', '09:12:46', 1, 189.000000, 189.000000),
	('ORD-00012', 'PR006', '2024-03-07', '09:14:58', 2, 159.000000, 318.000000);
