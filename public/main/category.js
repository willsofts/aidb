		const system_categories = {
			"AIDB1": {
				...
				examples: [
					...
					{"question":"Find out best seller 5 product's name of unit in March,2024"},
					{"question":"Find out top 5 customer's name of order amount in March,2024"}
				],
				selected: true,
			},
			"AIDB2": {
				...
				examples: [
					...
					{"question":"Find out registered trainee's name in March,2024"},
					{"question":"Find out top most training days from training schedule"}
				],
				selected: false,
			},
		}
